...
functions = {
	...
	Object: {
		...
		merge: (obj1, obj2, depth = 8, whiteList = false) ->
			do (obj1, obj2, depth, whiteList) ->
				if depth >= 1
					--depth
					...
					for own key of obj2
						if (
							...
							arguments.callee obj1[key], obj2[key], depth
						else
							if not whiteList or ( whiteList and key of obj1 and key of obj2 )
								obj1[key] = obj2[key]

				return obj1

		whiteMerge: (obj1, obj2, depth = 8) -> functions.Object.merge obj1, obj2, depth, true
